    ...
    <div class="col-lg-10">
      <div class="card">
        ...
        @endif
          ...
          {!!Form::open(['action' => 'ProductController@modifierproduit', 'method' => 'POST', 'class' =>'form-horizontal', 'enctype'=>'multipart/form-data'])!!}
          {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                {{Form::text('product_name',$produits->product_name,['class' => 'form-control','id'=> 'cname'])}}
              ...
              <div class="form-group">
                ...
                {{Form::number('product_price',$produits->product_price,['class' => 'form-control','id'=> 'cname'])}}
               
              </div>

              <div class="form-group">
                {{Form::label('','Catégorie du produit')}}
                  {{ Form::select('product_category', $categories, $produits->product_category,
